...
void MandelbrotGenerator::GenerateSubgroupAutoprecision(sycl::queue* q, uint32_t* imageBuffer, int width, int height, double left, double right, double top, double bottom)
{
	// Get a device allocation for the image array
	uint32_t* imageUSM = sycl::malloc_device<uint32_t>(width * height, *q);
